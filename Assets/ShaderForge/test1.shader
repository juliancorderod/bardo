...
////// Lighting:
                ...
                float node_4234 = 0.5*dot(lightDirection,i.normalDir)+0.5;
                float3 finalColor = lerp(lerp(_backTextureColor.rgb,_colorTexture_var.rgb,_backTexture_var.rgb),_colorTexture_var.rgb,floor((node_4234*attenuation) * _toonSteps) / (_toonSteps - 1));
