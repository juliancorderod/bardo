...
////// Lighting:
                ...
                float node_7904 = pow(1.0-max(0,dot(normalDirection, viewDirection)),0.7);
                float node_6257 = 3.0;
                float node_5967 = pow((1.0 - node_7904),node_6257);
                return fixed4(finalColor,(node_7233.b*_TextureColor.a*_backTexture_var.a*node_5967));
            }
            ENDCG
        }
    }
