...
////// Lighting:
                ...
                float3 finalColor = lerp(lerp(_LightColor0.rgb,node_6402,_backTexture_var.rgb),node_6402,lerp( node_8964, (1.0 - node_8964), _inverseShadow ));
